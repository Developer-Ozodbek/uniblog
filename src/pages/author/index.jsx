      ...
      <Layout>
        <Box sx={{display: 'flex', padding: '25px 30px', justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}>
          ...
          <Box sx={{display: 'flex', gap: '10px', flexWrap: 'wrap', justifyContent: 'center'}}>
            {authors.map(author => (
              <Box sx={{ display: 'flex', flexFlow: 'column wrap', padding: '25px 30px', borderRadius: '8px', gap: '10px', alignItems: 'center', boxShadow: 'rgba(9, 30, 66, 0.25) 0px 4px 8px -2px, rgba(9, 30, 66, 0.08) 0px 0px 0px 1px', cursor: 'pointer' }} onClick={()=> router.push(`/author/${author.slug}`)}>
